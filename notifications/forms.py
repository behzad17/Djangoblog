...
class NotificationPreferenceForm(forms.ModelForm):
    ...
    class Meta:
        ...
        labels = {
            ...
            'community_notifications': 'اعلان پاسخ‌های انجمن',
        ...
        help_texts = {
            ...
            'community_notifications': 'وقتی کسی به بحث شما پاسخ دهد.',
        ...
        widgets = {
            ...
            'community_notifications': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
